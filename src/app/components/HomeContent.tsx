...
const products = [
  ...
  function ProductCard({ product }: { product: Product }) {
    ...
    const height = 100;
    return (
      <div className=" flex justify-center flex-col w-[120px] bg-white rounded-lg shadow-lg">
...
function Tabs() {
    ...
    return (
        <div className="tabs flex flex-col w-full mb-10">
            <div className='flex justify-around mt-3 text-center p-2 '>
            ...
            <div id="panels" className='flex flex-col h-full'>
